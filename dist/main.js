...
var _someways = __webpack_require__(/*! ./someways */ "./src/someways.js");

var _someways2 = _interopRequireDefault(_someways);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

document.addEventListener("DOMContentLoaded", function () {
  var root = document.getElementById("root");
  _reactDom2.default.render(_react2.default.createElement(_someways2.default, null), root);
});
...
var _maze_generator = __webpack_require__(/*! ./maze_generator */ "./src/maze_generator.js");
...
var Maze = exports.Maze = function (_React$Component) {
  ...
  _createClass(Maze, [{
    ...
    value: function componentDidMount() {
      ...
      var start_positions = [[cellSize, height - cellSize], [cellSize, cellSize], [width - cellSize, height - cellSize]];
      var random_index = Math.floor(Math.random() * start_positions.length);
      var third = Math.floor(cellWidth * cellHeight / 3);
      var food = [third + Math.floor(Math.random() * third - 1)];
      var food_copy = food.map(function (el) {
        return el;
      });

      var start_pos = [start_positions[random_index][0], start_positions[random_index][1]];
      var start_array = [(width - cellSpacing) / (cellSize + cellSpacing) * ((height - cellSpacing) / (cellSize + cellSpacing) - 1), 0, (width - cellSpacing) / (cellSize + cellSpacing) * ((height - cellSpacing) / (cellSize + cellSpacing)) - 1];
      var start = start_array[random_index];
      var timer = 0;
      ...
      var ball = new _ball.Ball({ pos: start_pos, radius: cellSpacing - 1, ctx: ctx });
      this.maze = maze;
      this.ball = ball;
      ...
      function fillFood(index) {
        ...
        var j = Math.floor(index / cellWidth);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('canvas', { className: 'canvas', ref: this.canvas, width: width, height: height })
            ),
...
var MazeObj = exports.MazeObj = function () {
  function MazeObj(width, height, cellSize, cellSpacing, ctx) {
    _classCallCheck(this, MazeObj);
  ...
  _createClass(MazeObj, [{
    ...
    key: "toggleCell",
    value: function toggleCell(index, direction) {
      if (!this.cells[index]) {
    ...
    key: "exploreFrontier",
    value: function exploreFrontier() {
      var edge = popRandom(this.frontier);

      if (edge == null) {
        return true;
      };

      var current_cel_num = edge.index;
      var d0 = edge.direction;
      var next_cel_num = current_cel_num + (d0 === "N" ? -this.cellWidth : d0 === "S" ? this.cellWidth : d0 === "W" ? -1 : +1);
      var x0 = current_cel_num % this.cellWidth; //module times of cell+limit in current_cel_num
      var y0 = Math.floor(current_cel_num / this.cellWidth); //times of cell+limit in current_cel_num
      var x1 = void 0;
      var y1 = void 0;
      var d1 = void 0;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { className: 'title', href: 'https://nmenares.github.io/js_someways/' },
          'SomeWays'
        )
      ),
      _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h3',
          null,
          'Find the exit using the arrow keys! Don\'t forget to pass for the green square!'
        ),
